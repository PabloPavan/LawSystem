...
public class Pessoa {
    ...
    private String dataNascimento_pessoa;
    ...
    public String getDataNascimento_pessoa() {
        return dataNascimento_pessoa;
    }

    public void setDataNascimento_pessoa(String dataNascimento_pessoa) {
    ...
    public String getRua_pessoa() {
        return rua_pessoa;
    }

    public void setRua_pessoa(String rua_pessoa) {
        this.rua_pessoa = rua_pessoa;
    }
