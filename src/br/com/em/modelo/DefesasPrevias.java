...
public class DefesasPrevias {
    ...
    private String data_defesaPrevia;
    ...
    public String getId_defesaPrevia() {
        return id_defesaPrevia;
    }

    public void setId_defesaPrevia(String id_defesaPrevia) {
        this.id_defesaPrevia = id_defesaPrevia;
    }
    ...
    public String getData_defesaPrevia() {
        return data_defesaPrevia;
    }

    public void setData_defesaPrevia(String data_defesaPrevia) {
        this.data_defesaPrevia = data_defesaPrevia;
    }
