    ...
    public ArrayList<Cliente> listar(String nome, String t) {
        ...
        try {
            ...
            if (nome.isEmpty()) {
                ...
                String sql = ("SELECT p.*, c.* FROM modelo_tb_cliente c left join  modelo_tb_pessoa p on c.id_pessoa = p.id_pessoa; ");
                pst = this.conexao.prepareStatement(sql);
            } else {

                String sql = ("SELECT p.*, c.* FROM modelo_tb_cliente c left join  modelo_tb_pessoa p on c.id_pessoa = p.id_pessoa where p.nome_pessoa like ?;");
...
//                conexao = this.conector();
//                if (nome.isEmpty()) {
//                    String sql = "select  idcli,nomecli,sobrenomecli,cpfcli,rgcli from tbcliente where inativo like 'a' ";
//                    pst = this.conexao.prepareStatement(sql);
//                } else {
//
//                    String sql = "select  idcli,nomecli,sobrenomecli,cpfcli,rgcli from tbcliente where inativo like 'a' and nomecli like ? ";
//
//                    pst = this.conexao.prepareStatement(sql);
//                    pst.setString(1, nome + "%");
//                }
...
//                    c.setSobrenomecli(rs.getString("sobrenomecli"));
//                    c.setCpfcli(rs.getString("cpfcli"));
//                    c.setRgcli(rs.getString("rgcli"));
//                    lista.add(c);
//
//                }
//
